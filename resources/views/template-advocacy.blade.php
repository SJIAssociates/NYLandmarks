...
@section('content')
  ...
  <section class='full-section bg-blue-grey' id='' aria-label="News Section"  >
      ...
      <div class=' text-center'>
        <a href="/news/category/advocacy" class='archive-link underline text-black w-1/2 uppercase font-bold hover:text-primary'>View All Updates <i class='fa fa-chevron-right'></i></a>
      </div>
  	</div>
  </section>
