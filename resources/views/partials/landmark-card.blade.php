...
Variables:
  ...
  $permalink
--}}
<div class='landmark-card scroll-animations'>
    ...
    <div class='card w-full mt-32 lg:w-2/5 lg:my-24 lg:ml-32 p-5 xxl:px-20 xxl:py-16 xxl:my-48 mx-5'>
      ...
      <br>
      <a href="/explore-ny" class='archive-link uppercase hover:no-underline font-bold hover:text-red'>Explore other NY Landmarks<i class="fas fa-chevron-right"></i></a>
    </div>
</div>
