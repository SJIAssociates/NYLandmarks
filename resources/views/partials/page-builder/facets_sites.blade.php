@if($block->map == FALSE)
<section class='full-section {{ $block->block_type }}' aria-label="">
  <div class='container'>
    <div class='flex flex-wrap content'>
      ...
      <div class='filters w-full flex flex-wrap border-b-2 border-t-2 border-black pt-5 items-end sji-filters-top'>
        ...
        @if($block->filters)
          ...
          @endforeach
        @endif
        <button class='bg-black text-white self-end inline-block border-white border-2 hover:border-black hover:text-black px-10 py-2 mb-6 hover:bg-white lg:ml-auto w-full lg:w-auto' id='ResetBtn'>Reset</button>
      </div>
      @endif
