...
@section('content')
  ...
  @endwhile
<section id='staffFunnel' class='full-section bg-grey-lightest' aria-label="Board & Staff Section">
  <div class='container'>
...
<section class='full-section' aria-label="Annual Reports Section"  >
  <div class='container'>
    <div class="text-center">
		  <h2><span class='bg-white'>Annual Reports &amp; 990s</span></h2>
    </div>
    		  ...
    		  <div class='flex flex-wrap'>
      		  <div class='w-full lg:w-1/2 flex flex-col pr-8 justify-center'>
      		    ...
      		    <div class="button-container">
        		    <a href="{{ $annual_report->link }}" class='btn bg-red text-white inline-block mb-12 hover:no-underline'>View Annual Report</a><br>
      		    </div>
...
<section id="supporterFunnel"  class='full-section' aria-label="Supporters" >
  <div class='container'>
      <div class="text-center">
